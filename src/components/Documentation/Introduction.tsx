  ...
  return (
    <>
      <div id="version" className="md:scroll-m-[180px] scroll-m-28">
        ...
        <div className="mt-5">
          <p className="text-base font-medium text-midnight_text dark:text-white dark:text-opacity-50">Este sitio está construido con Tailwindcss y Nextjs.</p>
          <p className="text-base font-medium text-midnight_text dark:text-white dark:text-opacity-50">Este tema está listo para usar y puede personalizarlo completamente según sus necesidades.</p>
          <p className="text-base font-medium text-midnight_text dark:text-white dark:text-opacity-50">Para personalizar, debe tener conocimientos de NextJs, ReactJs, Tailwind y JSX para poder modificar este tema.</p>
        </div>
