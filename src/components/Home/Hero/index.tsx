      ...
      <div className='bg-gradient-to-b from-skyblue via-lightskyblue dark:via-[#4298b0] to-white/10 dark:to-black/10 overflow-hidden relative'>
        <div className='container max-w-8xl mx-auto px-5 2xl:px-0 pt-32 md:pt-60 md:pb-68'>
          <div className='relative text-white dark:text-dark text-center md:text-start z-10'>
            <p className='text-inherit text-xm font-medium'>Bogotá, Bosa Porvenir</p>
          ...
          <div className='hidden md:block absolute top-14 right-0 w-[720px] h-[620px] pointer-events-none'>
            <div className='absolute inset-0'>
              <Image
                src={'/images/categories/ferrary-cucina-carpinteria%20(23).jpeg'}
                alt='heroImg'
                fill
                sizes='720px'
                priority={true}
            ...
            <div className='absolute inset-0 bg-gradient-to-l from-transparent via-transparent to-skyblue' />
