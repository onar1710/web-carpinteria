          ...
          <div className="flex flex-col gap-10">
            <div>
              ...
              <div className="flex items-center gap-2.5">
                ...
                <p className="text-dark/50 dark:text-white/50 text-base">
                  Bogotá, Bosa Porvenir
                </p>
              </div>
            </div>
            <p className="text-base text-dark/50 dark:text-white/50">
              Diseño, fabricación e instalación con excelentes acabados. Trabajamos cocinas, clósets y carpintería general, y también remodelaciones en obra gris.
            </p>
            <div className="grid grid-cols-2 gap-10">
              <div className="flex items-center gap-4">
                ...
                <h6 className="">Diseño a medida</h6>
              </div>
              <div className="flex items-center gap-4">
                <div className="bg-dark/5 dark:bg-white/5 p-2.5 rounded-[6px]">
                  <Image
                ...
                <h6 className="">Instalación profesional</h6>
              </div>
              <div className="flex items-center gap-4">
                <div className="bg-dark/5 dark:bg-white/5 p-2.5 rounded-[6px]">
                  <Image
                ...
                <h6 className="">Materiales de calidad</h6>
              </div>
              <div className="flex items-center gap-4">
                <div className="bg-dark/5 dark:bg-white/5 p-2.5 rounded-[6px]">
                  <Image
